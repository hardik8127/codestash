  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-purple-500/3 rounded-full blur-xl"></div>
        <div className="absolute top-40 right-20 w-96 h-96 bg-blue-500/3 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-green-500/3 rounded-full blur-xl"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center pt-20 pb-12 px-6">
        <div className="text-center w-full mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="flex items-center gap-3 bg-gray-800/20 border border-gray-700/30 rounded-lg p-4 hover:bg-gray-700/20 transition-colors">
      ...
      <div className="relative z-10 px-6 pb-12">
        {problems.length > 0 ? (
          ...
          <div className="max-w-md mx-auto text-center">
            <div className="bg-gray-800/20 border border-dashed border-purple-500/20 rounded-xl p-8">
