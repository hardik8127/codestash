  ...
  return (
    <div className="w-full text-white">
      <div className="container-fluid px-0 mx-auto w-full">      {/* Hero Section */}      <motion.section 
        className="px-4 md:px-8 pt-8 pb-16 md:py-24 w-full max-w-full mx-auto relative overflow-hidden bg-[#060606]"
        initial="hidden"
        animate="visible"
      ...
      >
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#060606] via-transparent to-transparent z-10"></div>
        </div>
        <motion.div 
        ...
        >
        ...
        </motion.div>        <motion.div className="flex flex-col items-center text-center gap-6 relative z-20" variants={containerVariants}><motion.h1 
            className="text-5xl md:text-7xl font-bold text-white flex items-center justify-center gap-4"
          ...
          >
            <Link to={authUser ? "/home" : "/login"}>
              <motion.button 
                className="px-8 py-3 bg-blue-600 rounded-md font-medium text-white flex items-center gap-2 hover:bg-blue-700 transition-all"
            ...
            <Link to="/home">
              ...
              >
                Explore Challenges
              </motion.button>            </Link>          </motion.div>            <motion.div className="flex justify-center w-full mt-12 mb-16 px-4"            variants={heroItemVariants}>            <motion.div className="w-full max-w-3xl relative hero-code-block shadow-lg"              whileHover={{ scale: 1.02 }}
              transition={{ type: "spring", stiffness: 400, damping: 10 }}            >              <motion.div 
                className="relative bg-gray-800 border-0 rounded-xl shadow-md flex flex-col"
              ><div className="px-4 py-3 border-b border-gray-700 flex items-center">
                  ...
                  <div className="mx-auto text-gray-300 text-xs font-mono flex items-center">
                    <span className="bg-blue-700 px-2 py-1 rounded mr-2">JS</span>
                    solveProblem.js
                  </div>                </div>                <div className="p-6 flex-grow flex items-center overflow-hidden rounded-b-xl">
                  <pre className="text-left text-sm md:text-base w-full flex">
                    <div className="line-numbers text-gray-500 mr-4 select-none text-right">
                      ...
                      <span className="text-blue-400">function</span> <span className="text-blue-300">solveProblem</span>(<span className="text-gray-300">input</span>) {'{'
                      }
                      <br />  <span className="text-gray-500">// Your solution goes here</span>
                      <br />  <span className="text-blue-400">const</span> solution = input.<span className="text-blue-300">map</span>(<span className="text-gray-300">item</span> {'=>'} item * 2);
                      <br />  <span className="text-blue-400">return</span> solution;
